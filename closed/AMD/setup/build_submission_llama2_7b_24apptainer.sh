...
# VLLM_IMAGE_NAME="rocm/vllm-dev:rocm7.2.1_navi_ubuntu24.04_py3.12_pytorch_2.9_vllm_0.16.0"
# VLLM_IMAGE_NAME="rocm/vllm-dev:rocm6.2_ubuntu24.04_py3.12_pytorch_2.4_vllm_0.6.0"
VLLM_IMAGE_NAME="rocm/vllm-dev:rocm6.4.1_navi_ubuntu24.04_py3.12_pytorch_2.7_vllm_0.8.5"
...
if [[ "$ARCH" == "gfx950" ]]; then
    ...
    # VLLM_IMAGE_NAME="rocm/vllm-dev:rocm7.2.1_navi_ubuntu24.04_py3.12_pytorch_2.9_vllm_0.16.0"
    # VLLM_IMAGE_NAME="rocm/vllm-dev:rocm6.2_ubuntu24.04_py3.12_pytorch_2.4_vllm_0.6.0"
    # VLLM_IMAGE_NAME="rocm/vllm-dev:rocm6.1_ubuntu24.04_py3.12_pytorch_2.3_vllm_0.4.3"
    VLLM_IMAGE_NAME="rocm/vllm-dev:rocm6.4.1_navi_ubuntu24.04_py3.12_pytorch_2.7_vllm_0.8.5"
...
echo "Calling build_apptainer_24.sh with $VLLM_IMAGE_NAME"

bash "$SETUP_DIR/build_apptainer_24.sh" \
